...
class Molecule():
    ...
    def Mol(self,sequence, popSize, initialKE):
        ...
        self.molecules, self.stemPool, self.infoEnergy, self.moleculeEnergy, self.moleculeTable, self.basePairs,self.infoTable,self.moleculeShort = population.GenerateMolecule(sequence,len(sequence),popSize,self.infoTable)
