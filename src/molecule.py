...
class Molecule():
    ...
    def Mol(self,sequence, popSize, initialKE):
        ...
        self.molecules, self.stemPool, self.infoEnergy, self.moleculeEnergy, self.moleculeTable = population.GenerateMolecule(sequence,len(sequence),popSize,infoTable)
